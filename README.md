...
Jayden側では、追加された新しい会社行に対して、毎日AIエージェントが追加調査を行います。
...
ただし、AIは人が入力した値を勝手に上書きしない運用です。

瀬戸山さんに一番お願いしたいのは、AIだけでは判断しにくい「フォーム営業で使えるかどうか」の確認です。

特に次のような情報があると助かります。

- 実際にフォーム営業に使えそうな問い合わせフォームか
- フォーム営業の対象として良さそうな理由
- 対象外にした方がよい理由
- 会社の業務内容・業界についての人間目線の補足
- AIが間違えそうな会社名違い・別会社・閉業などの注意
